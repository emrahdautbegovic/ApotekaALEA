...
namespace PISprojekat.Controllers
{
    public class MessagesController : Controller
    {
        ...
        {
            var message = db.Message.Include(m => m.MessageAuthor).Include(m => m.MessageStatus);
        ...
        public ActionResult Create([Bind(Include = "ID,MessageText")] Message message)
        {
            ...
            {
                MessageAuthor messageAuthor = db.MessageAuthor.FirstOrDefault(ma => ma.ID == 2);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,MessageText,CreateDate,AuthorId,StatusId")] Message message)
        {
            if (ModelState.IsValid)
            {
